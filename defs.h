...
#define THING_DOOR_OPENER			THINGID
#define THING_LOCKPICK				THINGID+2
#define THING_SALT_WATER			THINGID+6
#define THING_KEY				THINGID+7
#define THING_TORCH				THINGID+8
#define THING_JUSTICIAR_BADGE			THINGID+16
#define THING_DART_TRAP_COMPONENT		THINGID+17
#define THING_ACID_TRAP_COMPONENT		THINGID+18
#define THING_SNARE_TRAP_COMPONENT		THINGID+19
#define THING_FIRE_TRAP_COMPONENT		THINGID+20
#define THING_TELEPORT_TRAP_COMPONENT		THINGID+21
#define THING_SLEEP_TRAP_COMPONENT		THINGID+22
#define THING_DISINTEGRATE_TRAP_COMPONENT	THINGID+23
#define THING_ABYSS_TRAP_COMPONENT		THINGID+24
#define THING_MANADRAIN_TRAP_COMPONENT		THINGID+25
