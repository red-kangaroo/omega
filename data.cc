...
"(T) HOUR: Use the normal clock, not the weird AM/PM nonsense. ;)\n"
...
",    : pick up object directly to backpack                        :     10*\n"
...
"                            '---'--'-/___\\-'--'---' \n"
"\n"
"                    Copyright (c) 1987 by Laurence R. Brothers\n"
"                        Copyright (c) 2007 by Mike Sharov\n"
"                             Modified by red_kangaroo";
//}}}2------------------------------------------------------------------
//{{{2 Religion scroll
