...
//    attack  aux2     y     id     hit     dmg    wake  speed   treas     weight  transf
    ...
    {NULL, 0, 0, 0, 0, 0, 0, 11,  1,  0,  0,  0, 10, 10, 1, 10,   0, 1,   5,    2, 50, SCROLL_SUMMON, -1, COMMON, M_TALK_STUPID, M_MOVE_FLUTTER, M_NO_OP, M_NO_OP, M_SP_SUMMON, 0, 0, 'f' | CLR (PURPLE), "fnord", "fnord's antennae", ""},
    ...
    {NULL, 0, 0, 0, 0, 0, 0, 14, 50,  0,  5,  0,  3,  3, 1, 24, 100, 2,  20,   20, 25, SCROLL_TELEPORT, -1, COMMON, M_TALK_STUPID, M_NO_OP, M_NO_OP, M_NO_OP, M_MOVE_TELEPORT, MOBILE, 0, 'b' | CLR (BRIGHT_WHITE) /*|CLR(FG_BLINK) */ , "blipper", "blipper organ", "BX"},
    ...
    {NULL, 0, 0, 0, 0, 0, 0, 16, 10, 10, 10, 10,  4,  4, 1,  9,  50, 1,  25,    5, 10, SCROLL_TRUESIGHT, -1, COMMON, M_TALK_SILENT, M_MOVE_SMART, M_MELEE_NORMAL, M_NO_OP, M_SP_ILLUSION, MOBILE | HOSTILE | POISONOUS, pow2 (SLEEP), 'p' | CLR (RED), "phantasticon", "phantasticon's eyes", "AXAXBX"},
    ...
    {NULL, 0, 0, 0, 0, 0, 0, 39,  7,  0,  0,  0, 10,  3, 2, 12,   0, 0,  40,    1, 10, SCROLL_LIGHT, -1, COMMON, M_NO_OP, M_NO_OP, M_NO_OP, M_NO_OP, M_SP_BLACKOUT, AWAKE | HOSTILE | POISONOUS, 0, 'f' | CLR (GREY), "murk fungus", "murk cloud particles", ""},
    ...
    {NULL, 0, 0, 0, 0, 0, 0, 84, 50, 12, 13, 10,  5,  5, 5,  5,   0, 4, 205,   10,500, -1, SCROLL_SPELLS, COMMON, M_TALK_EVIL, M_MOVE_SCAREDY, M_MELEE_NORMAL, M_NO_OP, M_SP_SPELL, MOBILE | HOSTILE, pow2 (FLAME) | pow2 (COLD) | pow2 (ELECTRICITY), 'n' | CLR (RED), "necromancer", "dead necromancer", "A?B?B?B?"},
    {NULL, 0, 0, 0, 0, 0, 0, 85, 40, 18, 18, 20,  5,  5, 5,  7,  50, 2, 175,    2, 10, SCROLL_LIGHT, -1, COMMON, M_TALK_EVIL, M_MOVE_SPIRIT, M_MELEE_SPIRIT, M_NO_OP, M_SP_BLACKOUT, MOBILE | HOSTILE | INTANGIBLE, pow2 (NORMAL_DAMAGE), 'S' | CLR (GREY), "shadow spirit", "shadowstuff", "ACACAC"},
    ...
    {NULL, 0, 0, 0, 0, 0, 0, 99,100,  0, 20,  0, 10,  3, 6,  3,   0, 5, 200,   10,  0, -1, THING_LOCKPICK, COMMON, M_TALK_THIEF, M_MOVE_SMART, M_NO_OP, M_NO_OP, M_SP_THIEF, MOBILE | HOSTILE | GREEDY | SWIMMING, 0, '@' | CLR (RED), "human", "dead master thief", "A?B?B?B?"},
    ...
    {NULL, 0, 0, 0, 0, 0, 0,112,150, 50, 10, 20,  1,  0, 7,  1, 100, 4, 400, 1500,  0, -1, -1, COMMON, M_NO_OP, M_NO_OP, M_MELEE_NORMAL, M_NO_OP, M_NO_OP, HOSTILE | HUNGRY, 0, OPEN_DOOR, "lurker at the threshold", "dead lurker", "L?L?L?"}, {NULL, 0, 0, 0, 0, 0, 0, 113, 50, 30, 30, 20, 10, 1, 7, 4, 0, 2, 450, 500, 0, -1, -1, COMMON, M_TALK_SILENT, M_MOVE_NORMAL, M_MELEE_SLEEP, M_NO_OP, M_NO_OP, MOBILE | HOSTILE | FLYING, pow2 (NORMAL_DAMAGE) | pow2 (SLEEP), 'S' | CLRS (YELLOW, BROWN), "sandman", "mound of sand", "AX"},
