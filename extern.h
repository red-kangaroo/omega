...
int test_file_access ARGS((char *, int));
...
void make_country_screen ARGS((int));
...
void maze_corridor ARGS((int,int,int,int,int,int));
...
void make_country_monsters ARGS((int));
...
int monster_hit ARGS((struct monster *,int,int));
void m_hit ARGS((struct monster *,int));
void monster_melee ARGS((struct monster *,int,int));
...
void draw_explosion ARGS((int,int,int));
...
void maddch ARGS((int));
void menuaddch ARGS((int));
...
void plotchar ARGS((int,int,int));
...
void do_los ARGS((int,int *,int *,int,int));
