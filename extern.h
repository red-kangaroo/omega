...
void maze_corridor (int,int,int,int,int,int);
...
void make_country_monsters (int);
...
int monster_hit (struct monster *,int,int);
void m_hit (struct monster *,int);
void monster_melee (struct monster *,int,int);
...
void do_los (int,int *,int *,int,int);
